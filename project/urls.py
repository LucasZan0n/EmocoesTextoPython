...
from AnaliseSentimentos.views import AtualizarLetra, AtualizarUsuario, DeletarLetra, ListarUsuario, LoginCreate, RegistroCreate, LetraCreate, LetraList, lista
